...
new Scroller({
   'el': document.getElementById('animated-path'),
	'startPoint': .6, // adjust up and down to trigger the location of the animation start relative to the viewport
	'endPoint': .3 // .5 and .5 is a 1:1 ratio with scroll. larger first number = faster than scroll. smaller first number = slower than scroll
});
